            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
              ...
              <section className="mb-6">
                ...
                <p className="text-gray-700">
                  Обмен / Возврат производится при условии <strong>сохранности товара, упаковки, бирок, наклеек, с описанием и инструкцией товара</strong>.
                </p>
              </section>
              ...
              <section className="mb-6">
                ...
                <ol className="pl-6 text-gray-700 list-decimal">
                  <li><strong>Доставляете товар своими силами.</strong></li>
                  <li>Приедет курьер, который произведет обмен. <strong>Стоимость услуги курьера составит 600 руб.</strong> (Москва: в пределах МКАД + до 5 км, далее 5 км от МКАД + <strong>25 руб / за 1км</strong>)</li>
                  <li>
                    Если товар был отправлен транспортной компанией и груз прибыл в город назначения, но клиент отказался от посылки и делает возврат товара, то <strong>все транспортные расходы в обе стороны полностью оплачиваются заказчиком</strong>.
                  </li>
                </ol>
              </section>
