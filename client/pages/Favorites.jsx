...
const mockFavorites = [
  { id: 1, name: "LANDOR полнорационный сухой корм для взрослых собак всех пород", price: 3000, weight: "1 кг", image: "/korm1.svg", dateAdded: "28.08.2025", isInStock: true },
  { id: 2, name: "LANDOR полнорационный сухой корм для взрослых собак всех пород", price: 3000, weight: "1 кг", image: "/korm1.svg", dateAdded: "28.08.2025", isInStock: false },
  { id: 3, name: "LANDOR полнорационный сухой корм для взрослых собак всех пород", price: 3000, weight: "1 кг", image: "/korm1.svg", dateAdded: "28.08.2025", isInStock: true },
];
...
export default function Favorites() {
  ...
  const allSelected = selected.size > 0 && favorites.length > 0 && favorites.every(i => selected.has(i.id));
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* контейнер: мобильный/планшет узкие отступы, ПК — как было */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-[80px] py-6 sm:py-8 lg:py-10">
        ...
        {/* ====== MOBILE/TABLET (≤ md) — карточный список ====== */}
        <div className="space-y-4 md:hidden">
          {/* Панель выбора все / удалить выбранные */}
          ...
          {favorites.map(item => (
            <div
              key={item.id}
              className="rounded-xl border border-[#E8E8E8] p-4 bg-white"
            >
        ...
        {/* ====== DESKTOP (≥ md) — твоя таблица как есть ====== */}
      ...
      {/* Рекомендации — отступы адаптивные через контейнер выше */}
