...
export default function Favorites() {
  ...
  const toggleOne = (id) => {
    setSelected((prev) => {
      ...
      // Чистим id, которых уже нет в избранном
        ...
        {isEmpty ? (
          ...
          <>
            ...
            <div className="space-y-4 md:hidden">
              ...
              {favorites.map((item) => (
                <div key={item.id} className="rounded-xl border border-[#E8E8E8] p-4 bg-white">
