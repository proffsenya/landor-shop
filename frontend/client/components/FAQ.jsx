...
export default function FAQ() {
  ...
  const faqs = [
    ...
    {
      question: "Можно ли смешивать сухой корм с консервами и какая должна быть пропорция?",
      answer:
        "Да, можно. Не забывайте о суточных нормах кормления и пересчитывайте их пропорционально рекомендациям, которые указаны на упаковке.",
    },
    {
