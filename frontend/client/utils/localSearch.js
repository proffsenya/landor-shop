...
const expandQuery = (query) => {
  ...
  const synonyms = {
    ...
    // Породы собак - мелкие
    'мелкие породы': ['мелких пород', 'для мелких пород', 'мелким породам', 'мелкие пород'],
    'мелких пород': ['мелкие породы', 'для мелких пород', 'мелким породам'],
    'для мелких пород': ['мелкие породы', 'мелких пород', 'мелким породам'],
    'мелким породам': ['мелкие породы', 'мелких пород', 'для мелких пород'],
    
    // Породы собак - средние
    'средние породы': ['средних пород', 'для средних пород', 'средним породам', 'средние пород'],
    'средних пород': ['средние породы', 'для средних пород', 'средним породам'],
    'для средних пород': ['средние породы', 'средних пород', 'средним породам'],
    'средним породам': ['средние породы', 'средних пород', 'для средних пород'],
    
    // Породы собак - крупные
    'крупные породы': ['крупных пород', 'для крупных пород', 'крупным породам', 'крупные пород'],
    'крупных пород': ['крупные породы', 'для крупных пород', 'крупным породам'],
    'для крупных пород': ['крупные породы', 'крупных пород', 'крупным породам'],
    'крупным породам': ['крупные породы', 'крупных пород', 'для крупных пород'],
