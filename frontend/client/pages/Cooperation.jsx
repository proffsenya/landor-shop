              ...
              <div className="bg-gradient-to-r from-[#6F2A2B] to-[#8a3a3c] rounded-2xl p-8 md:p-12 text-white mb-12">
                <div className="max-w-3xl">
                  ...
                  <p className="mb-6 opacity-95">
                    Предлагаем приобрести корма для собак и кошек оптом от производителя с доставкой по Москве и России по выгодным ценам. 
                    В наличии широкий ассортимент сухого и влажного корма.
                  </p>
